...
# visualizing decision tree - FOR SOME REASON THIS ISNT WORKING
# vip(pokemon_rf_final_fit)
```

The variables that are the most useful are . The variables that are the least useful are . This is/isn't what we expected because . 
